...
const penjumlahan = (angka1, angka2, angka3) => {
...
console.log(`diagonal pertama = ${satu} + ${lima} + ${sembilan} = ${diagonalPertama}`);
console.log(`diagonal kedua = ${nol} + ${lima} + ${tujuh} = ${diagonalKedua}`);
console.log(`maka hasilnya adalah ${diagonalPertama} - ${diagonalKedua} = ${hasilnya}`);
